...
class PedidoController extends Controller
{
    ...
    public function store(PedidocrearRequest $request)
    {
        ...
        if($input["estado"]==6 || $input["estado"]==1 ){
            ...
            $ventas_de=DB::insert("INSERT INTO ventas_detalle (venta_id, producto, cantidad) select pedido, producto, cantidad from pedidos_detalles where pedido = $pedido->id ");
